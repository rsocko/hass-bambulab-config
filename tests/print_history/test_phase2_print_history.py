...
class TestPrintHistoryTagEditorCard(unittest.TestCase):
    ...
    def test_tag_editor_card_resources_are_registered(self):
        ...
        self.assertIn("/local/3d_printing/print_history/print-history-3d-viewer-card.js?v=13", content)
    ...
    def test_archive_viewer_card_uses_proxy_endpoints_and_fallbacks(self):
        ...
        self.assertIn('Open Crop Tool', script)
        ...
        self.assertIn('_viewerPageUrl(mode)', script)
    ...
    def test_archive_viewer_page_supports_capture_preview_and_upload(self):
        ...
        self.assertIn('id="crop-toggle-button"', html)
        self.assertIn('id="crop-layer"', html)
        self.assertIn('id="crop-aspect-select"', html)
        self.assertIn('Landscape 16:9', html)
        self.assertIn('Square is the best starting point', html)
        self.assertIn('window.location.protocol === "file:"', html)
        self.assertIn('./print-history-3d-viewer-page.js?v=5', html)
        self.assertIn('/local/3d_printing/print_history/print-history-3d-viewer-page.js?v=5', html)
        self.assertIn('id="capture-panel"', html)
        self.assertNotIn('Upload + Use In List View', html)
        ...
        self.assertIn('setCropMode(true);', script)
        self.assertIn('cropPresetLabel()', script)
        self.assertIn('buildCornerRect(', script)
        self.assertIn('resolveAccessToken()', script)
        self.assertIn('function extractFilamentColorsFromGcode(gcodeText) {', script)
        self.assertIn('function resolvePreviewColors(capabilities, gcodeText) {', script)
        self.assertIn('function normalizePreviewGcode(gcodeText, maxToolIndex) {', script)
        self.assertIn('disableGradient: true', script)
        self.assertNotIn('uploadCapture(true)', script)
        self.assertNotIn('upload-primary-capture-button', script)
        ...
        self.assertNotIn('upload_archive_viewer_capture_primary_photo', integration)
        self.assertNotIn('use_as_primary', integration)
