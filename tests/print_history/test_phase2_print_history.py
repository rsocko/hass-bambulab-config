...
class TestPrintHistoryTagEditorCard(unittest.TestCase):
    ...
    def test_tag_editor_card_resources_are_registered(self):
        ...
        self.assertIn("/local/3d_printing/print_history/print-history-3d-viewer-card.js?v=12", content)
    ...
    def test_archive_viewer_card_uses_proxy_endpoints_and_fallbacks(self):
        ...
        self.assertIn('Upload + Use In List View', script)
    ...
    def test_archive_viewer_page_supports_capture_preview_and_upload(self):
        ...
        self.assertIn('./print-history-3d-viewer-page.js?v=4', html)
        self.assertIn('/local/3d_printing/print_history/print-history-3d-viewer-page.js?v=4', html)
