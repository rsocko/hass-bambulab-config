...
1. `dashboards/printer-temps.yaml` - Template file (all 3 card variants)
2. `dashboards/printer-temps-example.yaml` - Ready-to-use example
3. `PRINTER_TEMPS_IMPLEMENTATION.md` - Implementation notes
4. `dashboards/docs/printer-temps-cards.md` - Feature documentation
5. `dashboards/docs/printer-temps-visual-reference.md` - Visual examples
