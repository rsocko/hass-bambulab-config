...
**File**: `dashboards/led-controls.yaml`
...
1. **`dashboards/LED_CONTROLS_README.md`**
   - Quick start guide
   - Entity ID reference table
   - Setup instructions
   - Basic usage guide

2. **`dashboards/docs/led-controls.md`**
...
3. **`dashboards/docs/led-controls-visual.md`**
...
4. **`dashboards/docs/led-controls-integration-examples.md`**
...
1. **Copy file**: `dashboards/led-controls.yaml`
...
- **Quick Start**: `dashboards/LED_CONTROLS_README.md`
- **Full Docs**: `dashboards/docs/led-controls.md`
- **Visual Guide**: `dashboards/docs/led-controls-visual.md`
- **Integration**: `dashboards/docs/led-controls-integration-examples.md`
