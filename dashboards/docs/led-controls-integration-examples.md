...
4. Copy the entire content of `dashboards/led-controls.yaml`
...
1. **Primary Location**: Add as a new section in `dashboards/lovelace.3d_printing`
...
```yaml
# In dashboards/lovelace.3d_printing
...
- Main README: `dashboards/LED_CONTROLS_README.md`
- Full Documentation: `dashboards/docs/led-controls.md`
