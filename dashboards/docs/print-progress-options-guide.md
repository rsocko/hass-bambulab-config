...
- `dashboards/issue-516-options/option-1-bottom-bar-static.yaml`
- `dashboards/issue-516-options/option-2-bottom-bar-color-shift.yaml`
- `dashboards/issue-516-options/option-3-bottom-bar-animated.yaml`
- `dashboards/issue-516-options/option-4-full-fill-vertical.yaml`
- `dashboards/issue-516-options/option-5-full-fill-horizontal.yaml`
- `dashboards/issue-516-options/option-6-bottom-bar-milestones.yaml`
- `dashboards/issue-516-options/option-7-segmented-progress.yaml`

All seven options are included in the main dashboard under the existing KPI cards in `dashboards/lovelace.3d_printing`.
...
| 2 | Bottom progress bar, color shifts by completion | Fast "how close am I" scanning |
...
- Want progress urgency with color cues → **Option 2**
