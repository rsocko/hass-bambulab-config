...
### 1. Dashboard Configuration (`dashboards/lovelace.3d_printing`)
...
### 2. Documentation (`dashboards/docs/ams-tray-popup.md`)
...
### 3. README Updates (`dashboards/README.md`)
...
1. `/dashboards/lovelace.3d_printing` - Main dashboard (8 tap_action updates)
2. `/dashboards/README.md` - Feature documentation and requirements
3. `/dashboards/docs/ams-tray-popup.md` - Detailed popup documentation (NEW)
...
4. Review documentation in `/dashboards/docs/ams-tray-popup.md`
