...
**File**: `spoolman-sync/print_job_tracking_helpers.yaml`
...
**File**: `spoolman-sync/print_started-capture_print_data.yaml`
...
**File**: `spoolman-sync/print_complete-update_filament_usage.yaml`
...
**File**: `spoolman-sync/active_tray_changed_update_spoolman.yaml`
...
**File**: `spoolman-sync/manual_spoolman_recovery-script.yaml`
...
- `spoolman-sync/active_tray_changed_update_spoolman.yaml` (enhanced error messages)
- `spoolman-sync/README.md` (documentation links)
