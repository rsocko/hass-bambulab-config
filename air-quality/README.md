...
1. Open the dashboard file: `dashboards/air-quality-cards.yaml`
...
For each automation file in the `air-quality/` directory:
...
### Dashboard Cards
- **`dashboards/air-quality-cards.yaml`** - Complete dashboard card configurations
