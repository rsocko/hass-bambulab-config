...
input_number: !include notifications/notification_helpers.yaml
input_text: !include notifications/notification_helpers.yaml
input_datetime: !include notifications/notification_helpers.yaml

# Option B: Use package includes (recommended)
homeassistant:
  packages:
    printer_notifications: !include notifications/notification_helpers.yaml
```
...
3. Navigate to each file in the `notifications/` directory and import:
...
- !include notifications/print_complete_notification.yaml
- !include notifications/print_fault_notification.yaml
- !include notifications/print_started_notification.yaml
```
...
```bash
cp notifications/print_*.yaml /config/automations/
```
...
- 📖 Read the full [README.md](notifications/README.md) for advanced features
- 🗄️ Set up [Bambuddy integration](notifications/BAMBUDDY_INTEGRATION.md) for photo archiving
...
1. Check the full [README.md](notifications/README.md)
