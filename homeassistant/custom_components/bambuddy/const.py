...
SERVICE_GET_PRINT_HISTORY_TEMP_STORAGE_SUMMARY = "get_print_history_temp_storage_summary"
...
TIMELAPSE_DELETE_URL = "/api/bambuddy/print-history/archive/{archive_id}/timelapse"
...
ENTITY_TEMP_STORAGE = "bambuddy_print_history_temp_storage"