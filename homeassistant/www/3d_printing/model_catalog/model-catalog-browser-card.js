...
class ModelCatalogBrowserCard extends HTMLElement {
  ...
  _doRender() {
    ...
    if (!this._persistentStyle) {
      ...
      + '.collection-mosaic-tile:has(img[data-thumbnail-lazy-url]:not([src]))::after{content:"";position:absolute;inset:0;pointer-events:none;background:linear-gradient(90deg,transparent,rgba(255,255,255,0.07) 50%,transparent);transform:translateX(-100%);will-change:transform;animation:shimmer-slide 1.25s ease-in-out infinite;}'
      ...
      + '.skeleton-block::after{content:"";position:absolute;inset:0;background:linear-gradient(90deg,transparent,rgba(255,255,255,0.06) 50%,transparent);transform:translateX(-100%);will-change:transform;animation:shimmer-slide 1.25s ease-in-out infinite;}'
