...
class ModelCatalogBrowserCard extends HTMLElement {
  ...
  _doRender() {
    ...
    if (!this._persistentStyle) {
      ...
      + '.results.view-list .thumb img[data-thumbnail-lazy-url]:not([src]){animation:none;background-size:100% 100%;}'
      ...
      + '.results.view-list .skeleton-block{animation:none;background-size:100% 100%;}'
