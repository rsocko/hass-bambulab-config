(function () {
  ...
  var sharedStyles = ''
    ...
    + '.input,.select{width:100%;box-sizing:border-box;min-height:38px;padding:8px 10px;border-radius:12px;border:1px solid rgba(148,163,184,0.24);background:rgba(15,23,42,0.16);color:var(--primary-text-color);color-scheme:dark;}'
    + '.grow{flex:1 1 220px;}'
