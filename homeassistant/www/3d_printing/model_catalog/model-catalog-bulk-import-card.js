class ModelCatalogBulkImportCard extends HTMLElement {
  ...
  _render() {
    ...
    this.shadowRoot.innerHTML = ""
      ...
      + ".btn{cursor:pointer;background:#f7fafb;}"
      + ".btn.primary{background:#0d7a68;color:#fff;border-color:#0d7a68;}"
      ...
      + ".proposal{border:1px solid rgba(120,120,120,.25);border-radius:12px;padding:10px;background:#fbfcfd;}"
      ...
      + ".result.ok{background:#eafbf4;color:#175c3f;border:1px solid #7ed7a9;}"
