...
class ModelCatalogIntakeHomeCard extends HTMLElement {
  ...
  _render() {
    ...
    var directLaunchMode = !!this._normalizeLaunchWizardMode(this._launchWizardMode);
    var hideBaseSurface = directLaunchMode && this._wizardOpen;
    ...
    var extraStyles = ''
      ...
      + '.wizard-modal.launch-direct{position:static;display:flex;flex-direction:column;min-height:min(680px,80vh);padding:0;}'
      + '.wizard-modal.launch-direct .wizard-backdrop{display:none;}'
      + '.wizard-modal.launch-direct .wizard-dialog{flex:1;width:100%;max-width:100%;min-height:0;max-height:none;border-radius:12px;border:0;box-shadow:none;padding:20px;}'
