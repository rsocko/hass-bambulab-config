  ...
  _render() {
    ...
    this.shadowRoot.innerHTML = ''
      ...
      + '    ' + (visibleItems.length ? '<div class="items">' + visibleItems.map(function (item) {
          ...
          var sourceRecordId = String(sourceEntry.source_record_id || '').trim();
          ...
          return ''
            ...
            + ((sourceOrigin === 'MakerWorld API' && sourceRecordId) ? '<div class="muted">Publishing this queue item attaches the captured MakerWorld snapshot JSON as a supporting file on the local model.</div>' : '')
