class PrintHistoryPhotoGalleryCard extends HTMLElement {
  ...
  setConfig(config) {
    this._config = {
      ...
      archive_entity: config && config.archive_entity ? config.archive_entity : "sensor.bambuddy_print_history_browser_activity",
  ...
  _resolveArchive() {
    ...
    var entityId = this._config ? this._config.archive_entity : "sensor.bambuddy_print_history_browser_activity";
  ...
  _computeRenderSignature(hass) {
    ...
    var archiveEntityId = this._config.archive_entity || "sensor.bambuddy_print_history_browser_activity";
