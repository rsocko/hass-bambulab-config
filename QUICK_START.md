...
1. **Import Dashboard**:
   ...
   → Paste contents from dashboards/lovelace.3d_printing
   → Save
   ```
...
- **Technical Docs**: See `dashboards/docs/hms-error-alert-implementation.md`
- **Testing Guide**: See `dashboards/docs/hms-error-testing-guide.md`
- **Visual Examples**: See `dashboards/docs/hms-error-ui-mockup.md`
...
**Need Help?** Check the full documentation in the `dashboards/docs/` folder!
