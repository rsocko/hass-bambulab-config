...
| Doc | Package | Purpose |
|-----|---------|---------|
| [photo-capture-design.md](../../features/print_history/design/ui-media/photo-capture-design.md) | print_history | Multi-camera, multi-stage capture flow |
...
| [photo-review-design.md](../../features/print_history/design/ui-media/photo-review-design.md) | print_history | Post-print photo curation (remove/replace/cover) |
| [archive-detection-recovery-design.md](../../features/print_history/design/recovery/archive-detection-recovery-design.md) | print_history | Detect incomplete Bambuddy archives and define no-code-change repair options |
| [archive-mismatch-repair-design.md](../../features/print_history/design/recovery/archive-mismatch-repair-design.md) | print_history | Detect wrong-file archive records and define replacement-based repair options |
| [archive-detection-phase1-scope.md](../../features/print_history/planning/recovery/archive-detection-phase1-scope.md) | print_history | Collapsed recommended first build slice: detection and visibility only |
| [archive-detection-implementation-plan.md](../../features/print_history/planning/recovery/archive-detection-implementation-plan.md) | print_history | Design-only phased plan for HA detection, exception UX, and future recovery orchestration |
| [archive-recovery-n8n-design.md](../../features/print_history/design/recovery/archive-recovery-n8n-design.md) | print_history | `n8n` recovery workflow contract, retry policy, and outcome model |
| [archive-exception-ux-design.md](../../features/print_history/design/recovery/archive-exception-ux-design.md) | print_history | UX design for row markers, exception card, and status chip |
| [archive-detection-execution-checklist.md](../../features/print_history/planning/recovery/archive-detection-execution-checklist.md) | print_history | Design-to-build execution checklist for phased delivery |
...
| 15 | Photo capture automation | **Done** | Multi-trigger capture for start, mid-print, near-complete, and finish/error-adjacent flows — see [photo-capture-design.md](../../features/print_history/design/ui-media/photo-capture-design.md) |
...
- **Photo Review**: Current UI ships a status chip only; full post-print curation popup remains advanced follow-on work (see [design](../../features/print_history/design/ui-media/photo-review-design.md))
