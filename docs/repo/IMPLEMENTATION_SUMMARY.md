...
1. **Update Dashboard**:
  - Copy contents of [homeassistant/packages/3d_printing/core/dashboard_views/lovelace.3d_printing](../../homeassistant/packages/3d_printing/core/dashboard_views/lovelace.3d_printing) to your Home Assistant dashboard
