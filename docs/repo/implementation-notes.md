...
3. `/docs/features/printer_dashboards/reference/ams-tray-popup.md` - Detailed popup documentation (NEW)
...
4. Review documentation in `/docs/features/printer_dashboards/reference/ams-tray-popup.md`
