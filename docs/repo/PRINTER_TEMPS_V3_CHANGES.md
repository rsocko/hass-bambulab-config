...
1. [homeassistant/packages/3d_printing/printer_temps/dashboard_cards/printer-temps.yaml](../../homeassistant/packages/3d_printing/printer_temps/dashboard_cards/printer-temps.yaml) - Template file (all 3 card variants)
...
3. `PRINTER_TEMPS_IMPLEMENTATION.md` - Implementation notes
4. [docs/features/printer_dashboards/docs/printer-temps-cards.md](../features/printer_dashboards/docs/printer-temps-cards.md) - Feature documentation
