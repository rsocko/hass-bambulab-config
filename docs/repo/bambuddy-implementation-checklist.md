...
- [ ] Extend enrichment beyond the shipped `+>` payload toward richer provenance and optional native archive-status integration
...
1. Document and harden the shipped enrichment contract: managed tags + native cost + hidden `+>` notes payload.
