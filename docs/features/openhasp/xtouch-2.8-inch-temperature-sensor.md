...
- [DS18B20 Temperature Sensor Integration Guide](#ds18b20-temperature-sensor-integration-guide)
  - [Table of Contents](#table-of-contents)
  - [Introduction](#introduction)
  - [Required Hardware](#required-hardware)
  - [Installation Instructions](#installation-instructions)
    - [Step 1: Sensor Pinout and Connection](#step-1-sensor-pinout-and-connection)
    - [Step 2: Configuration on the xtouch Screen](#step-2-configuration-on-the-xtouch-screen)
  - [Monitoring Chamber Temperature](#monitoring-chamber-temperature)
...
DS18B20 sensor pinout image is not included in this repository snapshot.
