...
- Replaces: docs/features/wled/segment-reference.md
- Replaced By: n/a
...
**Functions** (see [LED Function Map](../design/light-scenarios.md#2-led-function-map-consolidated)):
...
For complete scenario catalog, see [light-scenarios.md](../design/light-scenarios.md).
...
> **How to retrieve**: Query `http://<wled-ip>/json/effects` â€” returns an array where the index is the effect ID.  
...
| 98 | Percent | S3 Printing (seg 0, 1), S4 Paused (seg 0, 1), S5 Error (seg 0, 1) | Progress bar fill â€” `ix` controls fill % (0â€“100 direct percentage) |
