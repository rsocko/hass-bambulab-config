...
- Replaces: docs/features/wled/hardware-constraint.md
- Replaced By: n/a
...
### DigQuad Segments (16 used, 0 spare â€” WLED maximum)

| Segment ID | Name | LEDs | Purpose |
|------------|------|------|---------|
| 0 | Front Door Bottom | 50 | Print progress bar |
| 1 | Front Door Left | 65 | Layer progress |
| 2 | Front Door Top | 43 | Status indicator |
| 3 | AMS 1 Tray Top | 58 | Combined lighting |
| 4 | AMS 1 Tray Bottom | 57 | Neutral background |
| 5 | AMS 2 Tray Top | 60 | Combined lighting |
| 6 | AMS 2 Tray Bottom | 55 | Neutral background |
| 7 | AMS 1 Tag A1 Top | 12 | Individual control |
| 8 | AMS 1 Tag A2 Top | 12 | Individual control |
| 9 | AMS 1 Tag A3 Top | 12 | Individual control |
| 10 | AMS 1 Tag A4 Top | 12 | Individual control |
| 11 | AMS 2 Tag B1 Top | 13 | Individual control |
| 12 | AMS 2 Tag B2 Top | 14 | Individual control |
| 13 | AMS 2 Tag B3 Top | 14 | Individual control |
| 14 | AMS 2 Tag B4 Top | 12 | Individual control |
| 15 | Neutral Backgrounds | ~125 | Combined hygrometers + tag bottoms |
...
âœ… Respects physical hardware constraints
âœ… No need to disconnect/reconnect LED strips
âœ… Current wiring remains intact
âœ… No risk of damaging connections

### Optimal Segment Usage
âœ… DigQuad uses 16 of 16 available segments (100% utilization â€” WLED maximum)
âœ… MagWLED uses 1 of 16 available segments (6.25% utilization)
âœ… Combined: 17 active segments across both controllers
âœ… Future expansion possible on MagWLED (15 segments available)

### Maintains All Functionality
âœ… Individual control of all 8 tray tags (A1-A4, B1-B4)
âœ… Print progress bar with dynamic updates
âœ… Layer progress on front door left
âœ… Status indication on front door top
âœ… Basic AMS lighting (combined per unit)
âœ… Neutral background lighting
âœ… Simple interior lid control
...
- âŒ "Move Interior Lid Light from MagWLED to DigQuad"
- âŒ "Free up MagWLED for future expansion"
- âŒ "Consolidate all LEDs on one controller"
...
- âœ… "Keep Interior Lid Light on MagWLED" - Respects hardware reality
- âœ… "DigQuad at full capacity" - Acknowledges constraint
- âœ… "Use both controllers" - Proper configuration
...
- Uses 16 segments on DigQuad (0 spare â€” WLED maximum)
...
**Configuration**: 16 segments on DigQuad + 1 on MagWLED = 17 active segments  
