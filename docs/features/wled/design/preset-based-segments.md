...
- Replaces: docs/features/wled/preset-based-segments.md
- Replaced By: n/a


> **STATUS: FUTURE (Phase 3)** â€” This is a valid advanced technique for Phase 3 of the implementation. It has not been deployed yet. The current system uses the state machine with presets 101â€“109. See [phased-implementation-guide.md](../planning/phased-implementation-guide.md).
...
Segment 7: A1 Tag Top (442-453)           â† ACTIVE TAG TOP
Segment 8: A1 Tag Bottom (502-513)        â† ACTIVE TAG BOTTOM
Segment 9: A2-A4 Tags Top (454-501)       â† Inactive tags combined
Segment 10: B1-B4 Tags Top (579-643)      â† AMS 2 tags combined
Segment 11: A2-A4 Tags Bottom (514-541)   â† Inactive bottoms combined
Segment 12: B1-B4 Tags Bottom (644-686)   â† AMS 2 bottoms combined
...
Segment 5: AMS 2 Tray Top (298-357)
Segment 6: AMS 2 Tray Bottom (382-436)
Segment 7: A2 Tag Top (454-465)           â† ACTIVE TAG TOP
Segment 8: A2 Tag Bottom (514-525)        â† ACTIVE TAG BOTTOM
Segment 9: A1, A3, A4 Tags Top Combined   â† Inactive tags
Segment 10: B1-B4 Tags Top Combined       â† AMS 2 tags
Segment 11: A1, A3, A4 Tags Bottom Combined â† Inactive bottoms
Segment 12: B1-B4 Tags Bottom Combined    â† AMS 2 bottoms
...
Segment 6: B1 Tag Top (579-591)           â† ACTIVE TAG TOP
Segment 7: B1 Tag Bottom (644-656)        â† ACTIVE TAG BOTTOM
Segment 8: A1-A4 Tags Top Combined        â† AMS 1 tags
Segment 9: B2-B4 Tags Top Combined        â† Inactive AMS 2 tags
Segment 10: A1-A4 Tags Bottom Combined    â† AMS 1 bottoms
Segment 11: B2-B4 Tags Bottom Combined    â† Inactive bottoms
