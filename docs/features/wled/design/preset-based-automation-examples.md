...
- Replaces: docs/features/wled/ha-automation-preset-based.md
- Replaced By: n/a


> **STATUS: FUTURE (Phase 3)** â€” These automations are designed for the preset-based segment approach (Phase 3). They have not been deployed. See [phased-implementation-guide.md](../planning/phased-implementation-guide.md).
