...
| Printing (base)                    | P2       | Door progress + green status + active tray color                                         | Door progress + per-tag-top                | Medium     | Partial                         | Mapped state/preset: `S3_PRINTING` / `104` plus overlay script for seg0/1 progress; active-tray color overlay not mapped yet. |
...
| AMS humidity high                  | P1       | Red hygrometer + AMS pulse                                                               | Per-AMS hygrometer ideal                   | High       | Not implemented                 | No mapped state/preset; no humidity threshold automation in active WLED package. |
| AMS humidity normal                | P3       | White hygrometer/base                                                                    | Per-AMS hygrometer ideal                   | High       | Not implemented                 | No mapped state/preset beyond baseline visuals from `S1/S3/S6` (`102/104/107`). |
...
| AMS tray actively feeding          | P2       | Bright active tray + subdued others                                                      | Per-tag-top                                | Medium     | Not implemented                 | No mapped state/preset; active-tray overlay remains planned Phase 3 work. |
| Active spool (A1..B4 variants)     | P2       | Highlight active tag top and corresponding spool zone                                    | Per-tag-top + per-tray AMS top is ideal    | High       | Not implemented                 | No mapped state/preset; spool-to-tag dynamic script not present. |
...
| Spool empty (multi-tray possible)  | P1       | Highlight one or more affected trays simultaneously                                      | Multi-tag-top simultaneous                 | High       | Not implemented                 | No mapped state/preset; multi-tray empty detection/overlay is missing. |
| Spool desiccant age warning        | P3       | Age color bands (yellow/orange/red), idle rotation scene only                            | Tag bottom per tray ideal                  | Medium     | Not implemented                 | No mapped state/preset; desiccant-age overlays/helpers not implemented. |
