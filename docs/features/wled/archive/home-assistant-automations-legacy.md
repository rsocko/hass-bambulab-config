...
- Replaces: docs/features/wled/home-assistant-automations.md
- Replaced By: n/a


> **STATUS: LEGACY** â€” These automations predate the Home Assistant State Machine. The current system uses a centralized orchestrator automation and scripts in the WLED HA package. See [ha-state-machine-package.md](../reference/ha-state-machine-package.md). The concepts and entity references here may still be useful for custom extensions.

This document provides example automations for controlling your WLED printer lighting based on Bambu Lab printer states.

For a complete catalog of all lighting scenarios, see [light-scenarios.md](../design/light-scenarios.md).
For LED specifications, see [digquad-led-segments.md](../reference/digquad-led-segments.md).
For zone functions, see [LED Function Map](../design/light-scenarios.md#2-led-function-map-consolidated).
...
Based on [light-scenarios.md](../design/light-scenarios.md), automations are organized into:
...
Reference [light-scenarios.md](../design/light-scenarios.md) for complete scenario details. Key automation mappings:
...
- **LED Counts**: Use actual counts from [digquad-led-segments.md](../reference/digquad-led-segments.md)
- **Functions**: Reference [LED Function Map](../design/light-scenarios.md#2-led-function-map-consolidated) for zone purposes
- **Scenarios**: See [light-scenarios.md](../design/light-scenarios.md) for all behaviors
...
- [LED Specifications](../reference/digquad-led-segments.md) - Exact LED counts and GPIO mapping
- [LED Function Map](../design/light-scenarios.md#2-led-function-map-consolidated) - Function specifications for each zone
- [Light Scenarios](../design/light-scenarios.md) - Complete catalog of 33+ scenarios
