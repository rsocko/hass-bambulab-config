...
- `docs/features/print_history/examples/archive-historical-backfill-inspect.json` shows bulk inspect output
- `docs/features/print_history/examples/archive-historical-backfill-full-one.json` shows that the backfill helper can create and annotate imported archives from a manifest entry
