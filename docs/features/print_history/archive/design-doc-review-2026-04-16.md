...
Replaces: docs/features/print_history/planning/design-doc-review-2026-04-16.md
Replaced By: none
...
| Timelapse lifecycle management (Advanced Features 2.9) | Partial. Popup timelapse viewing plus advanced-actions scan and upload/replace are now shipped, but review-state integration, candidate selection, delete/reprocess flows, and richer timelapse diagnostics are still open. | Update the phase summary and keep the remaining review/process work as active follow-on scope. |
