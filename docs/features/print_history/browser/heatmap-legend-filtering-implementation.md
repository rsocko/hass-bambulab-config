...
- Design Documentation: `docs/features/print_history/browser/heatmap-legend-filtering.md`
- Filter Architecture: `docs/features/print_history/browser/filter-sort-design.md`
