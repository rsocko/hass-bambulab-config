...
) reserves future archive-action slots in the popup instead of on the archive card face
...
It is not the same as the source-project `.3mf` import flow documented in [source-3mf-import-design.md](../
docs/features/print_history/design/
docs/features/print_history/design/
docs/features/print_history/design/imports/source-3mf-import-design.md


), which is intentionally scoped to image and limited metadata import.
