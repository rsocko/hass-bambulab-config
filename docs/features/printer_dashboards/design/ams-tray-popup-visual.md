...
![AMS tray popup — fallback/no spool matched](/docs/screenshots/images/ams-popup-no-spool.png)
...
![AMS tray popup — insufficient filament warning](/docs/screenshots/images/ams-popup-weight-warning.png)
