...
- `sensor.spoolman_tray_map` template sensor (from [homeassistant/packages/3d_printing/spoolman_sync/sensors/spoolman_tray_map.yaml](../../../../homeassistant/packages/3d_printing/spoolman_sync/sensors/spoolman_tray_map.yaml))
...
| [homeassistant/packages/3d_printing/spoolman_sync/sensors/spoolman_tray_map.yaml](../../../../homeassistant/packages/3d_printing/spoolman_sync/sensors/spoolman_tray_map.yaml) | `spoolman_tray_map` sensor template |
