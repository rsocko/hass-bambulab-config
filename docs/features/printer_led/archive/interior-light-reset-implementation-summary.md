...
5. **customization-examples.md** (14,711 bytes)
...
6. **visual-examples.md** (12,803 bytes)
...
7. **esp32-integration.md** (12,290 bytes)
...
8. **physical-button-integration.md** (12,046 bytes)
...
- Multiple preset buttons (documented in customization-examples.md)
