...
```yaml
# In your configuration.yaml
script: !include homeassistant/packages/3d_printing/interior_light/reset_interior_light_to_white-script.yaml
```
...
```
homeassistant/packages/3d_printing/interior_light/
├── README.md                                    # This file
