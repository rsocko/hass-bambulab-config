...
- [External Source Intake Design](design/external-source-intake.md) â€” Unified architecture for third-party and service-driven capture, generalized routing, review-first commit policy, and destination targeting across Model, Working Files, Idea, Project, and Collection flows (issues #1496, #1615-#1619, #183, #1179, #189, #232, #1266, #1372)
- [Social Saved Item Capture And Catalog Import Design](design/social-saved-item-capture-design.md) â€” Focused design for Instagram/Facebook saved-item extraction, open-source tooling options, browser extension and iOS Shortcut capture paths, and staged rollout into Catalog intake
- [MakerWorld URL Import Popup Assessment](design/makerworld-url-import-popup.md) â€” Recommended popup child wizard for MakerWorld URL intake, with shared-intake reuse guidance, Working Files destination handling, and direct-complete behavior for issues #1630 and #1627
- [Issue #1496 Various Sources Plan](planning/issue-1496-various-sources-plan.md) â€” Implementation slices, queue-review rules, adapter sequencing, and UI/data-contract work for the generalized intake-routing scope
- [Intake Source Routing Contract](reference/intake-source-routing-contract.md) â€” Draft enum, schema, validation, and endpoint contract for generalized mixed-source intake routing and target-aware commit flows
