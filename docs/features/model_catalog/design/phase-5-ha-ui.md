...
Working Files redesign details (superseding the #1169 group-first plan) are tracked in [/docs/features/model_catalog/design/working-files.md](/docs/features/model_catalog/design/working-files.md).
