...
> **Created**: 2026-03-26
> **Parent**: [AMS Tray Assignment Design](ams-tray-assignment-design.md)
...
| `docs/features/spoolman_sync/ams-tray-assignment-design.md` | Reference this document in Phase 5 or add a new phase entry |
