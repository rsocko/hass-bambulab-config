...
Replaces: docs/features/spoolman_sync/quick-reference.md
Replaced By: none
...
| `persistent-error-logging.md` | Full documentation |
| `error-logging-flow.md` | Flow diagrams |
| `persistent-error-logging-installation.md` | Step-by-step setup |
...
**Documentation**: See `persistent-error-logging.md` for full details
