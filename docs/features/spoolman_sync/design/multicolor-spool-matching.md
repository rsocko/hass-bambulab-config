...
Replaces: docs/features/spoolman_sync/multicolor-spool-matching-design.md
Replaced By: none
...
- [manual-spool-matching-design.md](manual-spool-matching.md)
...
- `docs/features/spoolman_sync/reference/spoolman-custom-fields.md`
