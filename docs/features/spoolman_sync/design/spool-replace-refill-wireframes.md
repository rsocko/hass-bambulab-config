...
> **Companion to:** [\docs\features\spoolman_sync\design\spool-replace-refill.md](\docs\features\spoolman_sync\design\spool-replace-refill.md)
...
- [ ] **Testing** — See [spool-replace-refill-test-plan.md](\docs\features\spoolman_sync\planning\spool-replace-refill-test-plan.md)
