# XTouch 2.8-inch OpenHASP Guide
...
5-inch preview image: see https://xtouch.pro/
...
2.8-inch screen photos are available on the linked product pages below.
...
Power pinout image is omitted in this archived document; use the board pin labels and vendor diagram.
