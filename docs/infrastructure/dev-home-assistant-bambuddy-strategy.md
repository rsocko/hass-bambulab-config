...
- Lovelace resource versioning and runtime registration are controlled by [docs/repo/dashboard-deployment-behavior.md](../repo/dashboard-deployment-behavior.md) and [homeassistant/packages/3d_printing/common/dashboards/_resources.yaml](../../homeassistant/packages/3d_printing/common/dashboards/_resources.yaml).
...
This contract is documented in [docs/repo/dashboard-deployment-behavior.md](../repo/dashboard-deployment-behavior.md).
...
- [docs/repo/deployment-workflow-reference.md](../repo/deployment-workflow-reference.md)
- [docs/repo/deployment-structure.md](../repo/deployment-structure.md)
- [docs/repo/dashboard-deployment-behavior.md](../repo/dashboard-deployment-behavior.md)