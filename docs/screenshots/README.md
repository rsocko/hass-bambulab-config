...
> **Guide:** See [Screenshot Guide](/docs/repo/reference/screenshot-guide.md) for format recommendations, capture tools, versioning, and embedding syntax.
...
| ✅ | `top-bar-desktop` | png | Top bar — desktop 2-column grid during active print | [Top Bar Layout](/docs/features/printer_dashboards/design/top-bar-layout.md) |
| ✅ | `top-bar-mobile` | png | Top bar — mobile single-column layout | [Top Bar Layout](/docs/features/printer_dashboards/design/top-bar-layout.md) |
| ✅ | `ams-popup-full-matched` | png | AMS popup — full matched spool view | [Ams Tray Popup Visual](/docs/features/printer_dashboards/design/ams-tray-popup-visual.md) |
| ✅ | `ams-popup-no-spool` | png | AMS popup — fallback/no spool matched | [Ams Tray Popup Visual](/docs/features/printer_dashboards/design/ams-tray-popup-visual.md) |
| ✅ | `ams-popup-weight-warning` | png | AMS popup — insufficient filament warning | [Ams Tray Popup Visual](/docs/features/printer_dashboards/design/ams-tray-popup-visual.md) |
| ⬜ | `ams-popup-desiccant-states` | png | AMS popup — desiccant status color states | [Ams Tray Popup Visual](/docs/features/printer_dashboards/design/ams-tray-popup-visual.md) |
...
| ✅ | `fan-controls-printing` | png | All fans active during print (varying speeds, colored icons) | [Fan Controls Visual](/docs/features/printer_controls/design/fan-controls-visual.md) |
| ⬜ | `fan-controls-idle` | png | All fans idle (grey icons, 0%/Off) | [Fan Controls Visual](/docs/features/printer_controls/design/fan-controls-visual.md) |
...
| ✅ | `temp-visual-heating` | png | Visual ref — heating state (red tint, borders) | [Printer Temps Visual Reference](/docs/features/printer_temps/design/printer-temps-visual-reference.md) |
| ⬜ | `temp-visual-cooling` | png | Visual ref — cooling state (blue tint, borders) | [Printer Temps Visual Reference](/docs/features/printer_temps/design/printer-temps-visual-reference.md) |
| ⬜ | `temp-visual-idle` | png | Visual ref — idle state (no color indicators) | [Printer Temps Visual Reference](/docs/features/printer_temps/design/printer-temps-visual-reference.md) |
...
| ✅ | `led-visual-full-grid` | png | Visual ref — full 7-light grid | [Visual Reference](/docs/features/printer_led/reference/led-controls/visual-reference.md) |
| ⬜ | `led-visual-wled-popup` | png | Visual ref — WLED popup control panel | [Visual Reference](/docs/features/printer_led/reference/led-controls/visual-reference.md) |
...
| ⬜ | `hms-ui-single-expanded` | png | UI mockup — single error expanded | [Hms Error Ui Mockup](/docs/features/error_alerts/design/hms-error-ui-mockup.md) |
| ⬜ | `hms-ui-multiple-errors` | png | UI mockup — multiple errors | [Hms Error Ui Mockup](/docs/features/error_alerts/design/hms-error-ui-mockup.md) |
| ⬜ | `hms-ui-collapsed` | png | UI mockup — collapsed state | [Hms Error Ui Mockup](/docs/features/error_alerts/design/hms-error-ui-mockup.md) |
...
| ✅ | `air-quality-visual-good` | png | Visual preview — good (all green) | [Visual Preview](/docs/features/air_quality/reference/visual-preview.md) |
| ⬜ | `air-quality-visual-moderate` | png | Visual preview — moderate (yellow) | [Visual Preview](/docs/features/air_quality/reference/visual-preview.md) |
| ⬜ | `air-quality-visual-poor` | png | Visual preview — poor (orange) | [Visual Preview](/docs/features/air_quality/reference/visual-preview.md) |
| ✅ | `air-quality-visual-purifier` | png | Visual preview — purifier controls ON | [Visual Preview](/docs/features/air_quality/reference/visual-preview.md) |
...
| Status | ID | Format | Description | Doc Location |
|--------|-----|--------|-------------|-------------|
| ⬜ | `bambuddy-print-history-card` | png | Legacy prototype print history card | [Bambuddy Reorganization Plan](/docs/repo/planning/bambuddy-reorganization-plan.md) |
| ⬜ | `bambuddy-queue-card` | png | Legacy prototype queue card | [Bambuddy Reorganization Plan](/docs/repo/planning/bambuddy-reorganization-plan.md) |
| ⬜ | `bambuddy-statistics-card` | png | Legacy prototype statistics card | [Bambuddy Reorganization Plan](/docs/repo/planning/bambuddy-reorganization-plan.md) |
| ⬜ | `bambuddy-maintenance-card` | png | Legacy prototype maintenance card | [Bambuddy Reorganization Plan](/docs/repo/planning/bambuddy-reorganization-plan.md) |
