...
**File**: [Popup Extension Points](/docs/features/model_catalog/design/popup-extension-points.md)
...
**File**: [Archive Candidate Review](/docs/features/model_catalog/planning/archive-candidate-review.md)
...
**File**: [Model Detail Popup](/docs/features/model_catalog/design/model-detail-popup.md) (sections updated)
