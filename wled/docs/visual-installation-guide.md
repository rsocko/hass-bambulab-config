...
### DO:
- ✅ Clean surfaces with isopropyl alcohol before mounting
- ✅ Test each strip before permanent installation
- ✅ Leave some slack in wires for adjustments
- ✅ Use cable ties to secure wires neatly
- ✅ Label each strip and connector
- ✅ Take photos during installation for reference
- ✅ Test power supply under full load before final install

### DON'T:
- ❌ Mount strips where they interfere with printer mechanics
- ❌ Pull or strain LED strips during installation
- ❌ Cut strips without measuring twice
- ❌ Block ventilation holes
- ❌ Use permanent adhesive until you're sure of placement
- ❌ Exceed power supply capacity
- ❌ Forget to connect grounds between controllers
...
**Print this guide and keep it handy during installation!**

For detailed configuration information, see:
- `README.md` - Overview and design
- `QUICK_START.md` - Step-by-step guide
- `docs/wiring-diagram.md` - Detailed wiring instructions
