...
- Frees MagWLED for future expansion
- Consolidates all LEDs on one controller

### Segment Changes
- **Front Door**: Merge left+top → 2 segments (was 3)
- **AMS Trays**: Combined top/bottom → 4 segments (2 per AMS)
- **Tag Tops**: Individual control → 8 segments (A1-A4, B1-B4)
- **Backgrounds**: Neutral soft white → 1 segment
- **Lid Interior**: Simple control → 1 segment
...
| Lid Interior | 15 | 1 | Simple lighting |
...
### Hardware
- [ ] 711 LEDs installed across 5 GPIO pins
- [ ] Interior Lid Light moved to DigQuad
- [ ] Power supply (15-20A @ 5V)
- [ ] All connections verified

### Configuration
- [ ] 16 segments defined in WLED
- [ ] Front door left+top merged
- [ ] Neutral backgrounds set to soft white
- [ ] All 31+ presets created
- [ ] Segments tested individually

### Integration
- [ ] Added to Home Assistant
- [ ] Automations for active tray switching
- [ ] Filament colors synced from Spoolman
...
1. ✅ All 711 LEDs light up correctly
2. ✅ Progress bar shows print progress
3. ✅ Status indicator changes with printer state
4. ✅ Active tray highlights with filament color
5. ✅ Inactive tags remain dim
6. ✅ Error states trigger appropriately
7. ✅ Loading/unloading animations work
8. ✅ System is stable and responsive

## 📚 Additional Resources

- [digquad-led-segments.md](digquad-led-segments.md) - Exact LED specifications
- [led-functions.md](led-functions.md) - Zone function details
- [light-scenarios.md](light-scenarios.md) - 33+ scenario catalog
